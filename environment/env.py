...
import random
import sys
# np.set_printoptions(threshold=sys.maxsize) #  If you get a truncated representation, but want the full array, try this!
...
class Map():
    ...
    def __init__(self, max_height, max_width, max_num_walls):
        ...
        self.width = np.random.randint(1,max_width)
        self.height = np.random.randint(1, max_height)
